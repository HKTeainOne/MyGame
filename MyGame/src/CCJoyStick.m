...
-(void)setDockTexture:(NSString *)imageName
{
    ...
    docktexture.opacity = 150.0f;
    
	[Dock addChild:docktexture];
}
// addBy LXY
-(void)setBallTexture2:(NSString *)imageName
{
	[Ball removeAllChildrenWithCleanup:TRUE];
	
	CCSprite *balltexture=[CCSprite spriteWithSpriteFrameName:imageName];
...
// addBy LXY
-(void)setDockTexture2:(NSString *)imageName
{
	[Dock removeAllChildrenWithCleanup:TRUE];
	
	CCSprite *docktexture=[CCSprite spriteWithSpriteFrameName:imageName];
    
    docktexture.color = ccRED;
